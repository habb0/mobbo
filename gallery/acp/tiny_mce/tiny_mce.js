(function (d) {
    ...
    var b = {majorVersion: "3", minorVersion: "4.5", releaseDate: "2011-09-06", _init: function () {
...
(function (d) {
    var f = d.VK, e = f.BACKSPACE, c = f.DELETE;
    function b (g) {
        var i = g.dom, h = g.selection;
        g.onKeyDown.add (function (k, o) {
            var j, p, m, n, l;
            l = o.keyCode == c;
            if (l || o.keyCode == e) {
                o.preventDefault ();
                j = h.getRng ();
                p = i.getParent (j.startContainer, i.isBlock);
                if (l) {
                    p = i.getNext (p, i.isBlock)
                }
                if (p) {
                    m = p.firstChild;
                ...
                k.getDoc ().execCommand (l ? "ForwardDelete" : "Delete", false, null);
                p = i.getParent (j.startContainer, i.isBlock);
                d.each (i.select ("span.Apple-style-span,font.Apple-style-span", p), function (r) {
                    var q = i.createRng ();
                    q.setStartBefore (r);
                    q.setEndBefore (r);
                    if (n) {
                        i.replace (n.cloneNode (false), r, true)
                    } else {
                        i.remove (r, true)
                    }
                    h.setRng (q)
    ...
    function a (g) {
        g.onKeyUp.add (function (h, j) {
            var i = j.keyCode;
            if (i == c || i == e) {
                if (h.dom.isEmpty (h.getBody ())) {
                    h.setContent ("", {format: "raw"});
                    h.nodeChanged ();
                    return
                }
            }
    ...
    d.create ("tinymce.util.Quirks", {Quirks: function (g) {
            if (d.isWebKit) {
                b (g);
                a (g)
            }
...
(function (m) {
    ...
    m.create ("tinymce.Editor", {Editor: function (r, q) {
            ...
            if (! b || ! m.relaxedDomain) {
                if (a && ! Range.prototype.getClientRects) {
                    q.onMouseDown.add (function (t, z) {
                        if (z.target.nodeName === "HTML") {
                            var s = q.getBody ();
                            s.blur ();
                            setTimeout (function () {
                                s.focus ()
