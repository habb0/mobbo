    ...
    tinymce.create ("tinymce.plugins.PastePlugin", {init: function (d, e) {
            ...
            if (/class="?Mso|style="[^"]*\bmso-|w:WordDocument/i.test (j) || e.wordContent) {
                ...
                if (b (k, "paste_convert_middot_lists")) {
                    d ([[/<!--\[if !supportLists\]-->/gi, "$&__MCE_ITEM__"], [/(<span[^>]+(?:mso-list:|:\s*symbol)[^>]+>)/gi, "$1__MCE_ITEM__"], [/(<p[^>]+(?:MsoListParagraph)[^>]+>)/gi, "$1__MCE_ITEM__"]])
                }
                ...
                if (b (k, "paste_retain_style_properties").replace (/^none$/i, "").length == 0) {
                    ...
                    d ([[/<span\s+style\s*=\s*"\s*mso-spacerun\s*:\s*yes\s*;?\s*"\s*>([\s\u00a0]*)<\/span>/gi, function (o, h) {
            ...
            if (b (k, "paste_convert_headers_to_strong")) {
                d ([[/<h[1-6][^>]*>/gi, "<p><strong>"], [/<\/h[1-6][^>]*>/gi, "</strong></p>"]])
            }
            d ([[/Version:[\d.]+\nStartHTML:\d+\nEndHTML:\d+\nStartFragment:\d+\nEndFragment:\d+/gi, ""]]);
            ...
            var d = this.editor, e = b (d, "paste_text_linebreaktype"), i = b (d, "paste_text_replacements"), f = tinymce.is;
            function h (j) {
                c (j, function (k) {
            ...
            if ((typeof (g) === "string") && (g.length > 0)) {
                if (/<(?:p|br|h[1-6]|ul|ol|dl|table|t[rdh]|div|blockquote|fieldset|pre|address|center)[^>]*>/i.test (g)) {
                    h ([/[\n\r]+/g])
                } else {
                    h ([/\r+/g])
                }
