    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var flashvars = {
                ...
                "client.reload.url": "http://www.vonushotel.com.br/client",
                "client.fatal.error.url": "http://www.vonushotel.com.br/client",
                "client.connection.failed.url": "http://www.vonushotel.com.br/client",
                "external.variables.txt": "http://127.0.0.1/swf/gamedata/external-variables-blue.txt",
                "external.texts.txt": "http://127.0.0.1/swf/gamedata/textos-externales-blue.txt",
                "productdata.load.url": "http://127.0.0.1/swf/gamedata/productdata-blue.txt",
                "furnidata.load.url": "http://127.0.0.1/swf/gamedata/furnidata-blue.txt",
                "use.sso.ticket": "1",
                "sso.ticket": "<?php echo $ticketrow['sessionticket']; ?>",
                "processlog.enabled": "1",
                "account_id": "1",
                "client.starting": "Por favor, espera... <?php echo $sitename; ?> Est� Carregando.",
                "flash.client.url": "http://127.0.0.1/swf/gordon/RELEASE63-201208211103-774468223/",
            ...
            var params = {
                "base": "http://127.0.0.1/swf/gordon/RELEASE63-201208211103-774468223/",
            ...
            var clientUrl = "http://127.0.0.1/swf/gordon/RELEASE63-201208211103-774468223/Hard.swf";
