...
abstract
     ...
     */
    protected
            function isVideoPost($path, $method = 'GET')
        {
     ...
     */
    protected
            function throwAPIException($result)
        {
    ...
    protected static
            function isAllowedDomain($big, $small)
        {
        if ($big === $small)
            {
            return true;
